package mod.acgaming.universaltweaks.bugfixes.world.teupdateorder.mixin;
...
@Mixin(Chunk.class)
public class UTTEUpdateOrderMixin
{
    ...
    public HashMap<BlockPos, TileEntity> utWrapLinkedHashMap(HashMap<BlockPos, TileEntity> hashMap)
    {
        ...
        if (UTConfig.DEBUG.utDebugToggle) UniversalTweaks.LOGGER.debug("UTTEUpdateOrder ::: Wrap linked hash map");
