...
public class UTMaxPlayerSpeedMixin
{
    ...
    {
        return (float) UTConfig.TWEAKS_ENTITIES.PLAYER_SPEED.utPlayerMaxSpeed;
    }

    @ModifyConstant(method = "processPlayer", constant = @Constant(floatValue = 300.0F))
    public float utModifyMaxElytraSpeed(float speed)
    {
        return (float) UTConfig.TWEAKS_ENTITIES.PLAYER_SPEED.utPlayerMaxElytraSpeed;
    }
    ...
    {
        return UTConfig.TWEAKS_ENTITIES.PLAYER_SPEED.utPlayerVehicleSpeed;
    }
}