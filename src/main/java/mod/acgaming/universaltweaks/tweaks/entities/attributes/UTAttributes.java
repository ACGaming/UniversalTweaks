...
import mod.acgaming.universaltweaks.mods.vanilla.mixin.UTRangedAttributeAccessor;
...
{
    protected static final IAttribute[] ATTRIBUTES = new IAttribute[] {MAX_HEALTH, FOLLOW_RANGE, KNOCKBACK_RESISTANCE, MOVEMENT_SPEED, FLYING_SPEED, ATTACK_DAMAGE, ATTACK_SPEED, ARMOR, ARMOR_TOUGHNESS, LUCK};
    ...
    public static void setValues(IAttribute attribute, double minValue, double maxValue)
    {
        try
        {
            ...
            {
                ((UTRangedAttributeAccessor) attribute).setMinimumValue(minValue);
                ((UTRangedAttributeAccessor) attribute).setMaximumValue(maxValue);
