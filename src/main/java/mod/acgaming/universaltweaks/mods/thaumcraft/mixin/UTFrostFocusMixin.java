...
public abstract class UTFrostFocusMixin extends FocusEffect
{
    ...
    {
        if (UTConfig.MOD_INTEGRATION.THAUMCRAFT.utTCFrostFocusSoundRevampToggle) caster.world.playSound(null, caster.getPosition().up(), SoundsTC.ice, SoundCategory.PLAYERS, 0.6F, 1.0F + (float) (caster.world.rand.nextGaussian() * 0.05F));
