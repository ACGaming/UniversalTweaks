    ...
    {
        {
            ...
            if (UTConfigGeneral.MASTER_SWITCHES.utMasterSwitchBugfixes)
            {
                ...
                put("mixins/bugfixes/mixins.entities.miningfatigue.json", c -> UTConfigBugfixes.ENTITIES.utMiningFatigueIIIToggle);
            ...
            if (UTConfigGeneral.MASTER_SWITCHES.utMasterSwitchTweaks)
            {
                ...
                put("mixins/tweaks/mixins.blocks.endportal.json", c -> UTConfigTweaks.BLOCKS.utRenderEndPortalBottom && !UTConfigTweaks.MISC.utEndPortalParallaxToggle);
    ...
    {
        {
            if (UTConfigGeneral.MASTER_SWITCHES.utMasterSwitchBugfixes)
            {
                ...
                put("mixins/bugfixes/mixins.world.culling.frustum.json", c -> UTConfigBugfixes.WORLD.utFrustumCullingToggle && !c.isModPresent("celeritas"));
